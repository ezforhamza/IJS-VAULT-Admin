...
// import { worker } from "./_mock"; // Disabled to use real APIs
import App from "./App";
...
// Mock Service Worker disabled - using real APIs
...
console.log("Using real APIs from:", GLOBAL_CONFIG.apiBaseUrl);
