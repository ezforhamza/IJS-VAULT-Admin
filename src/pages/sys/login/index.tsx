...
function LoginPage() {
	...
	return (
		<div className="relative grid min-h-svh lg:grid-cols-2 bg-background">
			...
			<div className="relative hidden bg-background-paper lg:flex lg:items-center lg:justify-center">
				<Lottie animationData={cyberSecurityAnimation} className="w-full h-full max-w-2xl" />
			</div>
