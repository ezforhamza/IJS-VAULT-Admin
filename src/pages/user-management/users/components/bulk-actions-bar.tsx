	...
	return (
		<Card className="mb-4 p-4">
			<div className="flex items-center justify-between">
				...
				<div className="flex items-center gap-2">
					{hasSuspendedUsers && (
						<Button variant="outline" size="sm" onClick={handleBulkActivate} disabled={bulkActivateMutation.isPending}>
							<Icon icon="solar:check-circle-outline" size={16} className="mr-2" />
							Activate
						</Button>
					)}

					<Button variant="outline" size="sm" onClick={handleBulkSuspend} disabled={bulkSuspendMutation.isPending}>
